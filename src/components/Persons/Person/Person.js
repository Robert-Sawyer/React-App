...
class Person extends Component {
    ...
    //Ta statyczna zmienna musi się nazywac DOKŁADNIE contextType i musi byc do niej dopasowane AuthContext.
    //Dzięki temu możemy użyc tego potem w Aux, przy autoryzacji.
        ...
        return (
            ...
            <Aux>
                ...
                <p key='i1' onClick={this.props.click}>
                    I am {this.props.name} and I'm {this.props.age} years old
                </p>
